...
def GameRules():
    ...
    print("If the final board value is lower than the target value, YOU WIN!")
...
Board = list(random.randint(21, size = 7, dtype=np.int64))
Target = random.randint(21, dtype=np.int64)
